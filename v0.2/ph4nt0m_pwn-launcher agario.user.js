// ==UserScript==
// @name        ph4nt0m_pwn-launcher BOT agario
// @namespace   ph4nt0m_pwn-launcher BOT agario
    ...
    window.jQuery.ajax({
            ...
            window.jQuery.get('https://raw.githubusercontent.com/OmniPhaser/Agar.io-bot/master/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                if (latestVersion > myVersion) {
                    ...
                    //update("aposLauncher", "launcher.user.js", "https://github.com/OmniPhaser/Agar.io-bot/blob/" + sha + "/launcher.user.js/");
                }
